...
namespace TrueCareer.Rpc.news
{
    ...
    {
        [Route(NewsRoute.SingleListAppUser), HttpPost]
        public async Task<List<News_AppUserDTO>> SingleListAppUser([FromBody] News_AppUserFilterDTO News_AppUserFilterDTO)
        {
        ...
        [Route(NewsRoute.SingleListNewsStatus), HttpPost]
        public async Task<List<News_NewsStatusDTO>> SingleListNewsStatus([FromBody] News_NewsStatusFilterDTO News_NewsStatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
