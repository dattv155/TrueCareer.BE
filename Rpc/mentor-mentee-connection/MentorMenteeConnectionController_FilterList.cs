...
namespace TrueCareer.Rpc.mentor_mentee_connection
{
    ...
    {
        [Route(MentorMenteeConnectionRoute.FilterListMentorConnection), HttpPost]
        public async Task<List<MentorMenteeConnection_MentorConnectionDTO>> FilterListMentorConnection([FromBody] MentorMenteeConnection_MentorConnectionFilterDTO MentorMenteeConnection_MentorConnectionFilterDTO)
        {
        ...
        [Route(MentorMenteeConnectionRoute.FilterListConnectionStatus), HttpPost]
        public async Task<List<MentorMenteeConnection_ConnectionStatusDTO>> FilterListConnectionStatus([FromBody] MentorMenteeConnection_ConnectionStatusFilterDTO MentorMenteeConnection_ConnectionStatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(MentorMenteeConnectionRoute.FilterListAppUser), HttpPost]
        public async Task<List<MentorMenteeConnection_AppUserDTO>> FilterListAppUser([FromBody] MentorMenteeConnection_AppUserFilterDTO MentorMenteeConnection_AppUserFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
