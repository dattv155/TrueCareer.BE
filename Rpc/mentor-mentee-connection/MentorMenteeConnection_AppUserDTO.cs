...
{
    public class MentorMenteeConnection_AppUserDTO : DataDTO
    {
        ...
        public MentorMenteeConnection_AppUserDTO() {}
        public MentorMenteeConnection_AppUserDTO(AppUser AppUser)
        {
    ...
    public class MentorMenteeConnection_AppUserFilterDTO : FilterDTO
    {
