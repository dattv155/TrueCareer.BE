...
{
    public class MentorReview_AppUserDTO : DataDTO
    {
        ...
        public MentorReview_AppUserDTO() {}
        public MentorReview_AppUserDTO(AppUser AppUser)
        {
    ...
    public class MentorReview_AppUserFilterDTO : FilterDTO
    {
