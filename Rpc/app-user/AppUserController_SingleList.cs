...
namespace TrueCareer.Rpc.app_user
{
    public partial class AppUserController 
    {
        ...
        [Route(AppUserRoute.SingleListFavouriteMentor), HttpPost]
        public async Task<List<AppUser_FavouriteMentorDTO>> SingleListFavouriteMentor([FromBody] AppUser_FavouriteMentorFilterDTO AppUser_FavouriteMentorFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(AppUserRoute.SingleListFavouriteNews), HttpPost]
        public async Task<List<AppUser_FavouriteNewsDTO>> SingleListFavouriteNews([FromBody] AppUser_FavouriteNewsFilterDTO AppUser_FavouriteNewsFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(AppUserRoute.SingleListNews), HttpPost]
        public async Task<List<AppUser_NewsDTO>> SingleListNews([FromBody] AppUser_NewsFilterDTO AppUser_NewsFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(AppUserRoute.SingleListInformation), HttpPost]
        public async Task<List<AppUser_InformationDTO>> SingleListInformation([FromBody] AppUser_InformationFilterDTO AppUser_InformationFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(AppUserRoute.SingleListInformationType), HttpPost]
        public async Task<List<AppUser_InformationTypeDTO>> SingleListInformationType([FromBody] AppUser_InformationTypeFilterDTO AppUser_InformationTypeFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(AppUserRoute.SingleListTopic), HttpPost]
        public async Task<List<AppUser_TopicDTO>> SingleListTopic([FromBody] AppUser_TopicFilterDTO AppUser_TopicFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
