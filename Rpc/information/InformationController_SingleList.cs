...
namespace TrueCareer.Rpc.information
{
    ...
    {
        [Route(InformationRoute.SingleListInformationType), HttpPost]
        public async Task<List<Information_InformationTypeDTO>> SingleListInformationType([FromBody] Information_InformationTypeFilterDTO Information_InformationTypeFilterDTO)
        {
        ...
        [Route(InformationRoute.SingleListTopic), HttpPost]
        public async Task<List<Information_TopicDTO>> SingleListTopic([FromBody] Information_TopicFilterDTO Information_TopicFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(InformationRoute.SingleListAppUser), HttpPost]
        public async Task<List<Information_AppUserDTO>> SingleListAppUser([FromBody] Information_AppUserFilterDTO Information_AppUserFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
