...
namespace TrueCareer.Rpc.comment
{
    ...
    {
        [Route(CommentRoute.SingleListAppUser), HttpPost]
        public async Task<List<Comment_AppUserDTO>> SingleListAppUser([FromBody] Comment_AppUserFilterDTO Comment_AppUserFilterDTO)
        {
