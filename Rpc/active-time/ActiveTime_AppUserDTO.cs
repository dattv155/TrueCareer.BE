...
{
    public class ActiveTime_AppUserDTO : DataDTO
    {
        ...
        public ActiveTime_AppUserDTO() {}
        public ActiveTime_AppUserDTO(AppUser AppUser)
        {
    ...
    public class ActiveTime_AppUserFilterDTO : FilterDTO
    {
