...
{
    public class Message_ConversationDTO : DataDTO
    {
        ...
        public Message_ConversationDTO() {}
        public Message_ConversationDTO(Conversation Conversation)
        {
    ...
    public class Message_ConversationFilterDTO : FilterDTO
    {
