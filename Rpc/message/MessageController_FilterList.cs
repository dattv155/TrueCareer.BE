...
namespace TrueCareer.Rpc.message
{
    ...
    {
        [Route(MessageRoute.FilterListConversation), HttpPost]
        public async Task<List<Message_ConversationDTO>> FilterListConversation([FromBody] Message_ConversationFilterDTO Message_ConversationFilterDTO)
        {
