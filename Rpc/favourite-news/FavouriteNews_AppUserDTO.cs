...
{
    public class FavouriteNews_AppUserDTO : DataDTO
    {
        ...
        public FavouriteNews_AppUserDTO() {}
        public FavouriteNews_AppUserDTO(AppUser AppUser)
        {
    ...
    public class FavouriteNews_AppUserFilterDTO : FilterDTO
    {
