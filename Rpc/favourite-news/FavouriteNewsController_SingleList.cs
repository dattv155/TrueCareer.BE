...
namespace TrueCareer.Rpc.favourite_news
{
    ...
    {
        [Route(FavouriteNewsRoute.SingleListNews), HttpPost]
        public async Task<List<FavouriteNews_NewsDTO>> SingleListNews([FromBody] FavouriteNews_NewsFilterDTO FavouriteNews_NewsFilterDTO)
        {
        ...
        [Route(FavouriteNewsRoute.SingleListAppUser), HttpPost]
        public async Task<List<FavouriteNews_AppUserDTO>> SingleListAppUser([FromBody] FavouriteNews_AppUserFilterDTO FavouriteNews_AppUserFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
