...
{
    public class MentorConnection_AppUserDTO : DataDTO
    {
        ...
        public MentorConnection_AppUserDTO() {}
        public MentorConnection_AppUserDTO(AppUser AppUser)
        {
    ...
    public class MentorConnection_AppUserFilterDTO : FilterDTO
    {
