...
namespace TrueCareer.Rpc.mentor_review
{
    ...
    {
        [Route(MentorReviewRoute.SingleListAppUser), HttpPost]
        public async Task<List<MentorReview_AppUserDTO>> SingleListAppUser([FromBody] MentorReview_AppUserFilterDTO MentorReview_AppUserFilterDTO)
        {
