...
namespace TrueCareer.Rpc.question
{
    ...
    {
        [Route(QuestionRoute.SingleListChoice), HttpPost]
        public async Task<List<Question_ChoiceDTO>> SingleListChoice([FromBody] Question_ChoiceFilterDTO Question_ChoiceFilterDTO)
        {
        ...
        [Route(QuestionRoute.SingleListMbtiSingleType), HttpPost]
        public async Task<List<Question_MbtiSingleTypeDTO>> SingleListMbtiSingleType([FromBody] Question_MbtiSingleTypeFilterDTO Question_MbtiSingleTypeFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
