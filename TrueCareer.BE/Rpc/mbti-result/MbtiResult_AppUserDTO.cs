...
{
    public class MbtiResult_AppUserDTO : DataDTO
    {
        ...
        public MbtiResult_AppUserDTO() {}
        public MbtiResult_AppUserDTO(AppUser AppUser)
        {
    ...
    public class MbtiResult_AppUserFilterDTO : FilterDTO
    {
