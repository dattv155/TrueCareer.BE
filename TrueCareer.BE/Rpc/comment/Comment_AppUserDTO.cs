...
{
    public class Comment_AppUserDTO : DataDTO
    {
        ...
        public Comment_AppUserDTO() {}
        public Comment_AppUserDTO(AppUser AppUser)
        {
    ...
    public class Comment_AppUserFilterDTO : FilterDTO
    {
