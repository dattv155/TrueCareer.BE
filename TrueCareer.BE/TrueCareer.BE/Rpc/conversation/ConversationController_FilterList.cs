...
namespace TrueCareer.Rpc.conversation
{
    ...
    {
        [Route(ConversationRoute.FilterListMessage), HttpPost]
        public async Task<List<Conversation_MessageDTO>> FilterListMessage([FromBody] Conversation_MessageFilterDTO Conversation_MessageFilterDTO)
        {
