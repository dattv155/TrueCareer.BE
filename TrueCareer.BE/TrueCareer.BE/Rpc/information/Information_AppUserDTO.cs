...
{
    public class Information_AppUserDTO : DataDTO
    {
        ...
        public Information_AppUserDTO() {}
        public Information_AppUserDTO(AppUser AppUser)
        {
    ...
    public class Information_AppUserFilterDTO : FilterDTO
    {
