...
namespace TrueCareer.Rpc.active_time
{
    ...
    {
        [Route(ActiveTimeRoute.FilterListAppUser), HttpPost]
        public async Task<List<ActiveTime_AppUserDTO>> FilterListAppUser([FromBody] ActiveTime_AppUserFilterDTO ActiveTime_AppUserFilterDTO)
        {
