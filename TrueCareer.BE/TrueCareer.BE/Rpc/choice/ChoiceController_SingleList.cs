...
namespace TrueCareer.Rpc.choice
{
    ...
    {
        [Route(ChoiceRoute.SingleListMbtiSingleType), HttpPost]
        public async Task<List<Choice_MbtiSingleTypeDTO>> SingleListMbtiSingleType([FromBody] Choice_MbtiSingleTypeFilterDTO Choice_MbtiSingleTypeFilterDTO)
        {
        ...
        [Route(ChoiceRoute.SingleListQuestion), HttpPost]
        public async Task<List<Choice_QuestionDTO>> SingleListQuestion([FromBody] Choice_QuestionFilterDTO Choice_QuestionFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
