...
namespace TrueCareer.Rpc.conversation_participant
{
    ...
    {
        [Route(ConversationParticipantRoute.SingleListConversation), HttpPost]
        public async Task<List<ConversationParticipant_ConversationDTO>> SingleListConversation([FromBody] ConversationParticipant_ConversationFilterDTO ConversationParticipant_ConversationFilterDTO)
        {
        ...
        [Route(ConversationParticipantRoute.SingleListAppUser), HttpPost]
        public async Task<List<ConversationParticipant_AppUserDTO>> SingleListAppUser([FromBody] ConversationParticipant_AppUserFilterDTO ConversationParticipant_AppUserFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
