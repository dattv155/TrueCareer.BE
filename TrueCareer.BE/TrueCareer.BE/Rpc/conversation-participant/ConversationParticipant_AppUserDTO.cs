...
{
    public class ConversationParticipant_AppUserDTO : DataDTO
    {
        ...
        public ConversationParticipant_AppUserDTO() {}
        public ConversationParticipant_AppUserDTO(AppUser AppUser)
        {
    ...
    public class ConversationParticipant_AppUserFilterDTO : FilterDTO
    {
