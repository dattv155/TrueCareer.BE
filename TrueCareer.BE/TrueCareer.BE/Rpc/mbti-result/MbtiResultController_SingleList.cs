...
namespace TrueCareer.Rpc.mbti_result
{
    ...
    {
        [Route(MbtiResultRoute.SingleListMbtiPersonalType), HttpPost]
        public async Task<List<MbtiResult_MbtiPersonalTypeDTO>> SingleListMbtiPersonalType([FromBody] MbtiResult_MbtiPersonalTypeFilterDTO MbtiResult_MbtiPersonalTypeFilterDTO)
        {
        ...
        [Route(MbtiResultRoute.SingleListAppUser), HttpPost]
        public async Task<List<MbtiResult_AppUserDTO>> SingleListAppUser([FromBody] MbtiResult_AppUserFilterDTO MbtiResult_AppUserFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
