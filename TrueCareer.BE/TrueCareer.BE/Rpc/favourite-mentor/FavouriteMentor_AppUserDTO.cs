...
{
    public class FavouriteMentor_AppUserDTO : DataDTO
    {
        ...
        public FavouriteMentor_AppUserDTO() {}
        public FavouriteMentor_AppUserDTO(AppUser AppUser)
        {
    ...
    public class FavouriteMentor_AppUserFilterDTO : FilterDTO
    {
