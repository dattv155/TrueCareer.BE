...
namespace TrueCareer.Rpc.favourite_mentor
{
    ...
    {
        [Route(FavouriteMentorRoute.SingleListAppUser), HttpPost]
        public async Task<List<FavouriteMentor_AppUserDTO>> SingleListAppUser([FromBody] FavouriteMentor_AppUserFilterDTO FavouriteMentor_AppUserFilterDTO)
        {
