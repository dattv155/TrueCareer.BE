...
{
    public class News_NewsDTO : DataDTO
    {
        ...
        public News_AppUserDTO Creator { get; set; }
        public News_NewsStatusDTO NewsStatus { get; set; }
        public Guid RowId { get; set; }
        public DateTime CreatedAt { get; set; }
        public DateTime UpdatedAt { get; set; }
        public News_NewsDTO() {}
        public News_NewsDTO(News News)
        {
            this.Id = News.Id;
            ...
            this.Creator = News.Creator == null ? null : new News_AppUserDTO(News.Creator);
            this.NewsStatus = News.NewsStatus == null ? null : new News_NewsStatusDTO(News.NewsStatus);
    ...
    public class News_NewsFilterDTO : FilterDTO
    {
